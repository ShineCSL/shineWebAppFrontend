...
currentAccount: any;
    ...
    loadAll() {
        this.publicHolidayService.query({
            page: this.page - 1,
            size: this.itemsPerPage,
            sort: this.sort()}).subscribe(
                (res: HttpResponse<PublicHoliday[]>) => this.onSuccess(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/public-holiday'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: PublicHoliday) {
        return item.id;
    }
    registerChangeInPublicHolidays() {
        this.eventSubscriber = this.eventManager.subscribe('publicHolidayListModification', (response) => this.loadAll());
    }
